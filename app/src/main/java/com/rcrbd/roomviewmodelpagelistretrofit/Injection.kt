...
package com.rcrbd.roomviewmodelpagelistretrofit

import android.content.Context
import androidx.lifecycle.ViewModelProvider
import com.rcrbd.roomviewmodelpagelistretrofit.ui.ViewModelFactory
...
object Injection {
    ...
    private fun provideGithubRepository(context: Context): GithubRepository {
        return GithubRepository(GithubApiService.create(), provideCache(context))
    }
